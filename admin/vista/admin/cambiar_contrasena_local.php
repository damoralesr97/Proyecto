<?php
    ...
    if(isset($_SESSION['usuario'])==null || $_SESSION['rol'] != "1"){
        header("Location: /Practica/public/vista/elegir_local.php");
    }
...
<html>
    ...
    <body>
        ...
        <form class="formEditarPerfil" method="POST" action="../../controladores/admin/cambiar_contrasena_local.php">
            <h4>EDITAR MI CONTRASEÑA</h4>
            <input type="hidden" name="codigo" id="codigo" value="<?php echo $codigoL ?>" class="campoED">
